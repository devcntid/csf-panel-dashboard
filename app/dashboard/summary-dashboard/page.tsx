                  ...
                  <table className="w-full text-sm min-w-[720px]">
                    <thead>
                      <tr className="border-b border-slate-100 bg-slate-50">
                        <th rowSpan={2} className="px-4 py-2 text-left text-xs font-semibold text-slate-600 border-r border-slate-200 sticky left-0 z-20 bg-slate-50">
                          Keterangan
                        </th>
                            ...
                            <Fragment key={`group-${section.title}-${group.title || 'default'}`}>
                              ...
                              {group.rows.map((row) => {
                                ...
                                return (
                                  ...
                                  >
                                    <td
                                      className={`px-4 py-2 border-r border-slate-200 whitespace-nowrap sticky left-0 z-10 bg-white ${
